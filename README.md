...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/slurm-pipeline-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14316&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/slurm-pipeline-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `slurm-pipeline` can be installed with:

```
conda install slurm-pipeline
```

It is possible to list all of the versions of `slurm-pipeline` available on your platform with:
